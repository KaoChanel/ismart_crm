...
class _SaleOrderDraftState extends State<SaleOrderDraft> {
  ...
  void setHeader() {
    ...
    globals.discountBillDraft = discountBill;
  ...
  void calculateSummary() {
    try {
      ...
      if (globals.discountType == globals.DiscountType.PER) {
        double percentDiscount = globals.discountBillDraft / 100;
        priceAfterDiscount = priceTotal - (percentDiscount * priceTotal);
      } else {
        priceAfterDiscount = priceTotal - globals.discountBillDraft;
      }
  ...
  Future<dynamic> postSaleOrder(String status) async {
    try {
      ...
      header.billDiscAmnt = globals.discountBillDraft;
